    ...
    <form class="recover-form" @submit.prevent="confirmEdit">
      <div class="row">
        <div class="col-md-6">
          ...
          <!-- Solo editable si el rol no es "Cliente" -->
          <label>
            <input type="radio" v-model="form.docType" value="1" :disabled="form.role === 3" /> Cédula de Ciudadanía
          </label>
          <label>
            <input type="radio" v-model="form.docType" value="2" :disabled="form.role === 3" /> Tarjeta de Identidad
          </label>
          <label>
            <input type="radio" v-model="form.docType" value="3" :disabled="form.role === 3" /> Cédula de Extranjería
          </label>
        ...
        <div class="col-md-6">
          ...
          <input type="text" id="id-number" v-model="form.idNumber" required :disabled="form.role === 3" /> <!-- Desactivado para "Cliente" -->
        ...
        <select id="role" class="select-field" v-model="form.role" required :disabled="form.role === 3">
